...
World.create(document.getElementById("scene-container") as HTMLDivElement, {
  ...
  world.registerSystem(RobotSystem).registerSystem(DropTTTSystem).registerSystem(CornholeSystem).registerSystem(RailroadSystem).registerSystem(BasketballSystem);
